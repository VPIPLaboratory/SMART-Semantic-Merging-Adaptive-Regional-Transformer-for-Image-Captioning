...
__C.DATA_LOADER.VAL_4W_ID = '/23085410113/23085410113/End-to-End-Transformer-Based-Model-for-Image-Captioning-main/mscoco/misc/ids2path_json/coco_val4w_ids2path.json'
...
__C.MODEL.BILINEAR.ENCODE_LAYERS = 3

__C.MODEL.BILINEAR.DECODE_LAYERS = 3
...
###########-----------------------####################
__C.SOLVER.XE_RL = 1   # For training�� XE 1, SCST 0
###########-----------------------####################
